...
class PluginProviderTest : StringSpec() {
    init {
        ...
        // so the EventLoopGroup lifecycle assertion runs on those platforms. On Windows
        // the test exercises the TCP path elsewhere and skips this UDS-specific check.
